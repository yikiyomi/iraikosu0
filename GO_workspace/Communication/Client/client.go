...
func(client *Client) Dealrespanse(){
	io.Copy(os.Stdout,client.conn)
	//一旦conn有数据就拷贝到stdout标准输出，永久阻塞监听
...
//私聊
func (client *Client) PrinvateChat(){
...
func main() {
	...
	//单独开启一个go处理server回执消息
	go client.Dealrespanse()
