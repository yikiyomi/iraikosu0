...
type User struct{
	...
	Password string `gorm:"not nil" json:"-"`
...
func main(){
	var err error
	dsn:="root:123456@tcg(127.0.0.1:3306)/allto?charset=utf8mb&parseTime=True&loc=Local"
...
func login(c *gin.Context){
	...
	c.JOSN(http.StatusOK,gin.H{"token":token})
}
